...
#  dir_combo             : folder where the QC images of pred_mask+target is overlayed on original data 
...
set dir_orig             = "training_orig"
set dir_combo            = "training_combo_pred_traget_orig"
